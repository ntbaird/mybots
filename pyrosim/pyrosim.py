...
def Get_Touch_Sensor_Value_For_Link(linkName):
    ...
    if(linkName in linkNamesToIndices):
        desiredLinkIndex = linkNamesToIndices[linkName]
    else:
        desiredLinkIndex = linkNamesToIndices['0']
...
def Send_Cube(name="default",pos=[0,0,0],size=[1,1,1], mass=1.0, color="0 1.0 1.0 1.0", colorName='Cyan'):
